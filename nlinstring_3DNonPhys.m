...
% interpolation
[Inpltv,Inptvl] = gridInterpDirichlet(Nl,Nt_ver,'cubic', bconditp); % interpolation matrices
[Inplth,Inpthl] = gridInterpDirichlet(Nl,Nt_hor,'cubic', bconditp); % interpolation matrices
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% continue here my friend, after doing the proper derivation
% from the theoretical acoustics book.
